 ...
 *
 * 在应用中要获取Connection,需要使用DataSourceUtils.getConnection();
 *
 ...
 *
 * 使用 TransactionAwareDataSourceProxy 兼容旧的使用DataSource.getConnection()获得的代码,其会在内部创建一个代理类
 *
...
public class DataSourceTransactionManager extends AbstractPlatformTransactionManager
    ...
    /**
     *
     * @return 获取一个事务，一般绑定在线程上通过doBegin绑定到TransactionSynchronizationManager上，通过本方法获取
     */
	@Override
	...
	protected void doBegin(Object transaction, TransactionDefinition definition) {
		...
		try {
			if (txObject.getConnectionHolder() == null ||
                ...
                // 未绑定，从数据源中获取，并设置到DataSourceTransactionObject中
